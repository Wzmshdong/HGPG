...
def main(opts):
    ...
    if not args.disable_pgn:
        ...
        pgn_settings = None
    model_config.pgn_settings = pgn_settings

    tokenizer = AutoTokenizer.from_pretrained('/root/mount/VLN-DUET/bert-base-uncased')
    ...
    if opts.checkpoint:
        ...
        if opts.init_pretrained == 'bert':
            ...
            tmp = torch.load(
                '/root/mount/VLN-DUET/datasets/pretrained/LXMERT/model_LXRT.pth', 
